...
class _Stepper2State extends State<StepperTouch>
  ...
  Widget build(BuildContext context) {
    return FittedBox(
      child: Container(
        width: widget.direction == Axis.horizontal ? 90.0 : 60.0,
        height: widget.direction == Axis.horizontal ? 35.0 : 120.0,
        child: Material(
          type: MaterialType.canvas,
          clipBehavior: Clip.antiAlias,
          borderRadius: BorderRadius.circular(60.0),
          color: widget.color2.withOpacity(1),
          child: Stack(
                    ...
                    child: Center(
                      child: AnimatedSwitcher(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              color: Color(0xFF6D72FF), fontSize: 20.0),
                        ),
                      ),
                    ),
                  ),
